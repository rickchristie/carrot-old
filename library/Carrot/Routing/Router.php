...
class Router implements RouterInterface
{
    ...
    public function routeRequest()
    {
        ...
        {
            throw new RuntimeException('Router error. Request already routed, you must not call Carrot\Routing\Router::routeRequest() more than once.');
        }
    ...
    protected function routeCLIRequest()
    {
        foreach ($this->routeIDs as $routeID => $type)
        {
            ...
            {
                throw new RuntimeException("Router error in routing CLI request. The CLI route '{$routeID}' does not implement Carrot\Routing\Route\CLIRouteInterface.");
            }
    ...
    {   
        foreach ($this->routeIDs as $routeID => $type)
        {
            ...
            {
                throw new RuntimeException("Router error in routing HTTP request. The HTTP route '{$routeID}' does not implement Carrot\Routing\Route\HTTPRouteInterface.");
            }
