...
class DependencyList
{
    ...
    public function __construct(array $list)
    {
        foreach ($list as $reference)
        {
            if ($reference instanceof Reference == FALSE)
            {
                ...
                throw new InvalidArgumentException("DependencyList error in instantiation. The list provided must contain only instances of Carrot\DependencyInjection\Reference, '{$unexpectedType}' found.");
            }
     ...
     * <code>
     * $list = array(
     *     'Carrot\Request{Singleton:}' => $referenceB,
     ...
     *     'Carrot\Request{Singleton:}' => $request,
