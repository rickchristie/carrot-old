...
/**
 * Represents the current request environment.
 *
 * Provides helper methods in accessing current request
...
class Request
{
    ...
    /**
     * Factory method, instantiates this class from superglobals
     * directly.
     *
     * @see __construct()
     *
    ...
    /**
     * Mengambil alamat IP dari client.
     *
     * @return string $ip
     *
     */
