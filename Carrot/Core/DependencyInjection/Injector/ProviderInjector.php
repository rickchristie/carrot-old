...
class ProviderInjector implements InjectorInterface
{
    ...
    public function inject(DependencyList $dependencyList)
    {
        ...
        if ($provider instanceof ProviderInterface == FALSE)
        {
            ...
            throw new RuntimeException("ProviderClassInjector error when trying to instantiate '{$id}'. The provider object does not implement Carrot\Core\DependencyInjection\Injector\ProviderInterface.");
        }
