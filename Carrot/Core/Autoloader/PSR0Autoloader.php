 ...
 * $autoloader->bindNamespace('Carrot\Core', '/absolute/path/to/directory');
 * </code>
 *
...
class PSR0Autoloader implements AutoloaderInterface
{
     ...
     * to directory saved with a trailing directory separator. The
     ...
     *
     * <code>
     * $autoloader->bindNamespace('Carrot\Core', '/vendors/Carrot/Core/');
     * </code>
     *
