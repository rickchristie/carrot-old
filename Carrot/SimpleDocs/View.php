...
class View
{
    ...
    protected function getHeader($pageTitle)
    {
        ...
        <head>
        	...
        	#sidebar ul { margin: 0 0 23px 0; padding: 0; list-style-type: none; line-height: 1.1; }
        	#sidebar ul li { margin: 9px 0; }
        	...
        	#content ul { margin: 20px 0 20px 0; padding: 0 0 0 0; list-style-type: none; }
        	#content ul li { margin: 7px 0; padding: 0 0 0 20px; }
        	h1 { font-size: 25px; margin: 20px 0 20px 0; }
            ...
            a:link { color: #f13900; }
    		a:visited { color: #ff5825; }
    		a:hover { color: #ff843a; }
            ...
            <?php foreach ($navArray as $topicName => $pages): ?>
                ...
                <ul>
                    ...
                    <li><a class="<?php echo $page['class'] ?>" href="<?php echo $page['url'] ?>">
                        <?php if ($page['class'] == 'current') echo '&rarr;'; ?>
    ...
    protected function getPageNotFoundContent()
    {
        ...
        <blockquote>You just keep pushing. You just keep pushing. I made every mistake that could be made. But I just kept pushing. <cite>- Rene Descartes</cite></blockquote>
