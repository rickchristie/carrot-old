 ...
 *
 * <code>
 * $mysqli = new Carrot\Database\MySQLiWrapper\MySQLi(
 *     'hostname',
 *     'username',
 *     'password',
 *     'database'
...
{   
    ...
    /**
     * @var array List of placeholders with 'blob' data type, set by the user - see {@see markParamAsBlob()}.
     */
    ...
    /**
     * @var array Contains references to the {@see $params} property, used for binding using parent::bind_param().
     */
    ...
    /**
     * @var array Contains references to the {@see $resultRow} property, used for binding using parent::bind_result().
     */
     ...
     *
     * Throws RuntimeException if an error occurred when creating the
     * statement object.
     * 
     ...
     * </code>
     * 
     * Will throw RuntimeException if execution fails.
     * 
     * @throws RuntimeException
    ...
    public function execute(array $params = array())
    {
        ...
        if (!$result)
        {
            throw new RuntimeException("Statement execution error! Error #{$this->errno}: '{$this->error}', statement is '{$this->query}'.");
        }
    ...
    /**
     * Disable binding parameters from outside of the class.
     * 
     * Since this class uses placeholders in executing, there would be
     * no need of calling this method from outside of the class.
     * Calling this method could potentially cause unknown problems in
     * this class. Hence this method is overridden with an empty
     * method body.
     *
     */
     ...
     *
     * Since this class uses special fetch* methods, there would be no
     * need to call this method from outside of the class. Calling
     * this could potentially cause unknown problems in this class.
     * Hence this method is overridden with an empty method body.
     *
     */
    ...
    /**
     * Fill the parameters array and binds parameters for the next execution.
     *
    ...
    /**
     * Fills parameter types string to the $paramsReferences property.
     * 
