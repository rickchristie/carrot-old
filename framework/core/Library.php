...
/**
 * The class to be extended by user/framework libraries.
 *
 * This class extends the Base class. Since libraries are not supposed to
 * have dependencies to models or views, it is set private so that the
 * children of this class will not be able to set it.
 * 
