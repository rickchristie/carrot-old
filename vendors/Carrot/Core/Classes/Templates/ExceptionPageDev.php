...
<head>
	...
	<style>
		...
		.exception-code-container ol.trace-0 li.current span.line-num
		{
			background: #fe6b6b;
		...
		.exception-code-container ol.trace-0 li.current pre
		{
			background: #fe6b6b;
			color: #fff;
		}
...
<div id="wrapper">
	<h2>Uncaught Exception: <?php echo get_class($exception) ?></h2>
	<p>
	...
	<?php
		...
		if (empty($stacktrace))
		{
			echo 'No trace, just the front controller (<code>index.php</code>).';
		}
